		...
		if (check.success_count == 5)
		{
			...
			if (check.error_count == 1) {
				...
				if (check.error[0] > 2)
				{
					...
					{
					case 0:
						printf("*USER STATUS* 섹션 1번째 CRC가 변조됨\n");
						break;
					case 1:
						printf("*ITEMS* 섹션 1번째 CRC가 변조됨\n");
						break;
					case 2:
						printf("*FRIENDS LIST* 섹션 1번째 CRC가 변조됨\n");
						break;
					case 3:
						printf("*DESCRIPTION* 섹션 1번째 CRC가 변조됨\n");
						break;
					default:
						break;
					}
				...
				if (check.error[1] > 2)
				{
					...
					{
					case 0:
						printf("*USER STATUS* 섹션 2번째 CRC가 변조됨\n");
						break;
					case 1:
						printf("*ITEMS* 섹션 2번째 CRC가 변조됨\n");
						break;
					case 2:
						printf("*FRIENDS LIST* 섹션 2번째 CRC가 변조됨\n");
						break;
					case 3:
						printf("*DESCRIPTION* 섹션 2번째 CRC가 변조됨\n");
						break;
					default:
						break;
					}
				}
				if (!(check.error[0] > 2 && check.error[1] > 2))
				{
					switch (i)
					{
					case 0:
